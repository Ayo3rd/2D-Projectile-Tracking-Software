...
//////
//////    Ptr<Tracker> tracker; //MedianF works but slow
//////    tracker = TrackerMedianFlow::create();
//////
//////
//////    // Read video
//////    VideoCapture video("Hockey_Video_1.mp4");
...
//////        int temp = int(fps);
//////        String strFPS = to_string(temp);
//////        putText(frame, "FPS : " + strFPS, Point(100, 50), FONT_HERSHEY_SIMPLEX, 0.75, Scalar(50, 170, 50), 2);
//////
//////        // Display frame.
//////        namedWindow("Tracking", WINDOW_NORMAL);
//////        imshow("Tracking", frame);
